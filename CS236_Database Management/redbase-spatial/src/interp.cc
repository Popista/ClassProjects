...
static int mk_attr_infos(NODE *list, int max, AttrInfo attrInfos[])
{
   ...
   for(i = 0; list != NULL; ++i, list = list -> u.LIST.next) {
      ...
      attrInfos[i].attrType = type;
       printf("in mk_attr_infos\n");
      cout << attrInfos[i].attrType << "\n";
