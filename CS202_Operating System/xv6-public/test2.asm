...
int main(void)
{
   ...
   6:	83 ec 10             	sub    $0x10,%esp
	int a;
	a = fork();
   9:	e8 fd 01 00 00       	call   20b <fork>
	printf(1,"pid: %d\n", a);
   e:	89 44 24 08          	mov    %eax,0x8(%esp)
  12:	c7 44 24 04 9e 06 00 	movl   $0x69e,0x4(%esp)
  19:	00 
  1a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  21:	e8 56 03 00 00       	call   37c <printf>
    printf(1,"syscallnum: %d\n", syscallnum());
  26:	e8 98 02 00 00       	call   2c3 <syscallnum>
  2b:	89 44 24 08          	mov    %eax,0x8(%esp)
  2f:	c7 44 24 04 a7 06 00 	movl   $0x6a7,0x4(%esp)
  36:	00 
  37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  3e:	e8 39 03 00 00       	call   37c <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 320:	f7 f1                	div    %ecx
 322:	8a 92 be 06 00 00    	mov    0x6be(%edx),%dl
...
printf(int fd, char *fmt, ...)
 ...
 539:	e9 85 fe ff ff       	jmp    3c3 <printf+0x47>
          s = "(null)";
 53e:	bf b7 06 00 00       	mov    $0x6b7,%edi
...
free(void *ap)
{
 ...
 554:	a1 50 09 00 00       	mov    0x950,%eax
 ...
 58f:	89 10                	mov    %edx,(%eax)
  freep = p;
 591:	a3 50 09 00 00       	mov    %eax,0x950
}
 596:	5b                   	pop    %ebx
 597:	5e                   	pop    %esi
 598:	5f                   	pop    %edi
 ...
 5bc:	89 10                	mov    %edx,(%eax)
  freep = p;
 5be:	a3 50 09 00 00       	mov    %eax,0x950
}
 5c3:	5b                   	pop    %ebx
 5c4:	5e                   	pop    %esi
 5c5:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5da:	46                   	inc    %esi
  if((prevp = freep) == 0){
 5db:	8b 15 50 09 00 00    	mov    0x950,%edx
 ...
 607:	3b 05 50 09 00 00    	cmp    0x950,%eax
 ...
 631:	e8 12 ff ff ff       	call   548 <free>
  return freep;
 636:	8b 15 50 09 00 00    	mov    0x950,%edx
 ...
 650:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 653:	89 15 50 09 00 00    	mov    %edx,0x950
      return (void*)(p + 1);
 ...
 67d:	09 00 00 
 680:	c7 05 54 09 00 00 54 	movl   $0x954,0x954
 687:	09 00 00 
    base.s.size = 0;
 68a:	c7 05 58 09 00 00 00 	movl   $0x0,0x958
 691:	00 00 00 
 694:	b8 54 09 00 00       	mov    $0x954,%eax
