...
main(int argc, char *argv[])
  ...
  25:	e8 61 02 00 00       	call   28b <unlink>
  ...
  41:	c7 44 24 04 da 06 00 	movl   $0x6da,0x4(%esp)
  48:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 348:	f7 f1                	div    %ecx
 34a:	8a 92 fa 06 00 00    	mov    0x6fa(%edx),%dl
...
printf(int fd, char *fmt, ...)
 ...
 561:	e9 85 fe ff ff       	jmp    3eb <printf+0x47>
          s = "(null)";
 566:	bf f3 06 00 00       	mov    $0x6f3,%edi
...
free(void *ap)
{
 ...
 57c:	a1 90 09 00 00       	mov    0x990,%eax
 ...
 5e4:	89 10                	mov    %edx,(%eax)
  freep = p;
 5e6:	a3 90 09 00 00       	mov    %eax,0x990
}
 5eb:	5b                   	pop    %ebx
 5ec:	5e                   	pop    %esi
 5ed:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 602:	46                   	inc    %esi
  if((prevp = freep) == 0){
 603:	8b 15 90 09 00 00    	mov    0x990,%edx
 ...
 62f:	3b 05 90 09 00 00    	cmp    0x990,%eax
 ...
 659:	e8 12 ff ff ff       	call   570 <free>
  return freep;
 65e:	8b 15 90 09 00 00    	mov    0x990,%edx
 ...
 678:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 67b:	89 15 90 09 00 00    	mov    %edx,0x990
      return (void*)(p + 1);
 ...
 69c:	eb dd                	jmp    67b <malloc+0x8b>
    base.s.ptr = freep = prevp = &base;
 69e:	c7 05 90 09 00 00 94 	movl   $0x994,0x990
 6a5:	09 00 00 
 6a8:	c7 05 94 09 00 00 94 	movl   $0x994,0x994
 6af:	09 00 00 
    base.s.size = 0;
 6b2:	c7 05 98 09 00 00 00 	movl   $0x0,0x998
 6b9:	00 00 00 
 6bc:	b8 94 09 00 00       	mov    $0x994,%eax
