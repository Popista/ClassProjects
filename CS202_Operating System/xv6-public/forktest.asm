...
0000003c <forktest>:
{
  ...
  printf(1, "fork test\n");
  43:	c7 44 24 04 b0 03 00 	movl   $0x3b0,0x4(%esp)
  4a:	00 
  ...
  printf(1, "fork test OK\n");
  8c:	c7 44 24 04 e2 03 00 	movl   $0x3e2,0x4(%esp)
  93:	00 
  ...
  af:	00 
  b0:	c7 44 24 04 f0 03 00 	movl   $0x3f0,0x4(%esp)
  b7:	00 
  ...
  c9:	c7 44 24 04 bb 03 00 	movl   $0x3bb,0x4(%esp)
  d0:	00 
  ...
  e2:	c7 44 24 04 cf 03 00 	movl   $0x3cf,0x4(%esp)
  e9:	00 
...
00000397 <setpass>:
 397:	b8 1c 00 00 00       	mov    $0x1c,%eax
 39c:	cd 40                	int    $0x40
 39e:	c3                   	ret    

0000039f <join>:
 39f:	b8 1d 00 00 00       	mov    $0x1d,%eax
 3a4:	cd 40                	int    $0x40
 3a6:	c3                   	ret    

000003a7 <clone1>:
 3a7:	b8 1e 00 00 00       	mov    $0x1e,%eax
 3ac:	cd 40                	int    $0x40
 3ae:	c3                   	ret    
